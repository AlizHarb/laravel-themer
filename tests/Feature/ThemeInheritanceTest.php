...
it('supports multi-level inheritance for views', function () {
    ...
    $gp = new Theme('grandparent', '/grandparent/path', hasViews: true);
    $p = new Theme('parent', '/parent/path', parent: 'grandparent', hasViews: true);
    $c = new Theme('child', '/child/path', parent: 'parent', hasViews: true);
...
it('supports multi-level inheritance for livewire', function () {
    ...
    $gp = new Theme('gp', '/path/gp', hasLivewire: true);
    $p = new Theme('p', '/path/p', parent: 'gp', hasLivewire: true);
    $c = new Theme('c', '/path/c', parent: 'p', hasLivewire: true);
